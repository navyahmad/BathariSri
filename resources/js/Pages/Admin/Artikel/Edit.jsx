...
export default function ArtikelEdit({ artikel }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('admin.artikel.update', artikel.id));
    };
            ...
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1 truncate max-w-xs">{artikel.title}</p>
                    </div>
                </div>
            }
        >
            ...
            <div className="max-w-3xl">
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {artikel.is_published && !data.is_published && (
                            <span className="text-xs text-orange-600 font-medium">
                                (Artikel akan menjadi draft)
                            </span>
                        )}
                    </div>
