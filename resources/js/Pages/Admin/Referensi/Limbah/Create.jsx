...
export default function LimbahCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.referensi.limbah.store'));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Tambah Harga Limbah</h1>
                        <p className="text-sm text-gray-500 mt-1">Tambah data harga limbah padi baru</p>
                    </div>
                </div>
            }
        >
            <Head title="Tambah Harga Limbah" />
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={inputClass}
                            placeholder="Contoh: Kompos, Biogas, Pakan Ternak"
                        />
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        >
                            {processing ? 'Menyimpan...' : 'Simpan Limbah'}
                        </button>
                        <Link
                            href={route('admin.referensi.limbah.index')}
