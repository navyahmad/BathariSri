...
export default function PenyakitCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.referensi.penyakit.store'));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Tambah Penyakit</h1>
                        <p className="text-sm text-gray-500 mt-1">Tambah data referensi penyakit padi baru</p>
                    </div>
                </div>
            }
        >
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Contoh: blast, blight"
                            />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={inputClass}
                            placeholder="Contoh: Magnaporthe oryzae"
                        />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Penjelasan umum tentang penyakit ini..."
                        />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className={textareaClass}
                            placeholder="Gejala yang terlihat pada tanaman..."
                        />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className={textareaClass}
                            placeholder="Langkah-langkah pencegahan penyakit ini..."
                        />
