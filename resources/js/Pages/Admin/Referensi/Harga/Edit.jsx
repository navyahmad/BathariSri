...
export default function HargaEdit({ harga }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('admin.referensi.harga.update', harga.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Edit Harga Komoditas</h1>
                        <p className="text-sm text-gray-500 mt-1">Ubah data harga: {harga.komoditas}</p>
                    </div>
                </div>
            }
        >
            <Head title="Edit Harga Komoditas" />
